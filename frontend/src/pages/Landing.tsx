  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 text-center">
        ...
        >
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full glass border border-slate-200 text-xs font-medium text-indigo-600 mb-6">
            <Sparkles size={14} />
        ...
        >
          <div className="glass-card max-w-4xl mx-auto aspect-video flex items-center justify-center overflow-hidden group">
            <img 
            ...
            <div className="absolute bottom-8 left-8 text-left">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-xs font-mono text-emerald-600">AI SYSTEM ACTIVE</span>
              </div>
              <h3 className="text-xl font-bold">Personalized Roadmap #4829</h3>
              <p className="text-sm text-slate-600">Quantum Computing Specialist Path</p>
            </div>
          </div>
        </motion.div>
      </section>
