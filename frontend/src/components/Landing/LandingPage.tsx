    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10 px-4">
        ...
        <motion.div
          ...
          className="hidden lg:block relative h-[700px] w-full lg:translate-x-0 lg:-translate-y-12"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-1/2 -translate-x-1/2 lg:left-auto lg:right-12 lg:translate-x-0 w-full max-w-[700px] px-6 z-50 pointer-events-none group"
      >
        {/* Core Magical Glow */}
        <motion.div 
          animate={{ 
          ...
          className="absolute inset-0 bg-gradient-to-t from-brand-pink/40 via-brand-purple/30 to-transparent blur-[100px] -z-10 rounded-full"
        />
        ...
        <motion.div 
          ...
          className="absolute inset-0 border-[20px] border-brand-pink/20 blur-[40px] -z-10 rounded-full"
        />
        ...
        {[...Array(12)].map((_, i) => (
          <motion.div
            ...
            className={cn(
              "absolute rounded-full blur-[0.5px] shadow-[0_0_15px_white]",
              i % 3 === 0 ? "w-2 h-2 bg-white" : "w-1 h-1 bg-brand-pink"
            )}
            style={{ 
              left: `${15 + (i * 6)}%`, 
              bottom: '25%' 
        ...
        <motion.img 
          src="/book.png" 
          alt="Book" 
          className="w-full h-auto object-contain drop-shadow-[0_0_30px_rgba(236,72,153,0.4)] relative z-10" 
        />
      </motion.div>
                ...
                <div className="bg-white p-8 rounded-3xl border border-border-light shadow-sm flex flex-col md:flex-row gap-8 relative overflow-hidden group">
                  ...
                  <div className="flex-1 h-40 md:h-auto bg-gray-50/50 rounded-2xl border border-dashed border-gray-200 flex items-center justify-center group-hover:bg-brand-pink/[0.02] transition-colors">
                    <div className="relative text-center">
                      <img src="/image.png" alt="Logo" className="w-16 h-auto opacity-20 animate-pulse mx-auto" />
